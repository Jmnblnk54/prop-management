...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyDglFoX0YIGy3FsakY0xeAz85xS5wC9dFs"),
    authDomain: ("TURBOPACK compile-time value", "prop-management-c119c.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "prop-management-c119c"),
    storageBucket: ("TURBOPACK compile-time value", "prop-management-c119c.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "574207121470"),
    appId: ("TURBOPACK compile-time value", "1:574207121470:web:ff8f013231bea28998196f")
};
                ...
                "AuthProvider.useEffect.unsubscribe": async (firebaseUser)=>{
                    ...
                    if (firebaseUser) {
                        ...
                        if (!userSnap.exists()) {
                            ...
                            const defaultRole = firebaseUser.email === "admin@example.com" ? "admin" : "user"; // or 'tenant'
                            const newUser = {
